        ...
        return(
            <>
                <div className = "container text-center mx-auto mt-5 mb-5 text-dark">
                    <img src = "https://zerodha.com/static/images/landing.png" alt = "Broker" height = {"275px"} width = {"425px"} className = "mt-4 mb-5"></img>
                ...
                <div className = "container mx-auto mt-5 text-dark py-5">
                    <div className = "row mt-5 d-flex justify-content-between py-5">
                        <div className = "col-6">
                            <img src = "https://zerodha.com/static/images/largest-broker.svg" alt = "Largest Broker"></img>
                        </div>
                        <div className = "col-6">
                            ...
                            <img src = "https://zerodha.com/static/images/press-logos.png" alt = "Press Logos" className = "img-fluid mb-3"></img>
                        </div>
                    </div>
                </div>
                <div className = "container mx-auto mt-5 mb-4 text-center">
                    ...
                    <img src = "https://zerodha.com/static/images/ecosystem.png" alt = "ecosystem" className = "img-fluid"></img>
                ...
                <div className = "container mt-5 py-5">
                    <div className = "row mt-5">
                        <div className = "col-6">
                            <img src = "https://zerodha.com/static/images/index-education.svg" alt = "index-education" height = {"300"}></img>
                        </div>
